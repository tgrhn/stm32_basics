...
TButton *btnVerifyFreesync2;
    ...
    TLabel *Hex;
    TComboBox *combOCCMinCT;
    TComboBox *combOCCMaxCT;
    ...
    TEdit *Edit31;
    TEdit *Edit32;
    TCheckBox *chkbFS2LockCT;
    TComboBox *combFS2MinCT;
    TComboBox *combFS2MaxCT;
    TLabel *Label53;
    TLabel *Label54;
    TLabel *Label55;
    TLabel *Label58;
    TLabel *Label60;
    TCheckBox *chkbBT2020UserMode;
...
public:		// User declarations
    ...
    bool __fastcall OCCCTInitial(int nCT,float x,float y);
    bool __fastcall FS2CTInitial(int nCT);
