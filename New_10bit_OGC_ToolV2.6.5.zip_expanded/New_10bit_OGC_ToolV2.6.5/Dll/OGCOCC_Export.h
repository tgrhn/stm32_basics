...
typedef void(*func_rtdGammaSetOCCTxy)(float *Txy);
typedef float(*func_rtdGammaGetOCCTxy)(int nXorY);
typedef void(*func_rtdGammaSetFS2Txy)(float *Txy);
typedef float(*func_rtdGammaGetFS2Txy)(int nXorY);
...
typedef void(*func_rtdGammaSetFS2LockCT)(bool bLockCT);
typedef bool(*func_rtdGammaGetFS2LockCT)(void);
...
extern func_rtdGammaSetOCCTxy g_rtdGammaSetOCCTxy;
extern func_rtdGammaGetOCCTxy g_rtdGammaGetOCCTxy;
extern func_rtdGammaSetFS2Txy g_rtdGammaSetFS2Txy;
extern func_rtdGammaGetFS2Txy g_rtdGammaGetFS2Txy;
...
extern func_rtdGammaSetFS2LockCT g_rtdGammaSetFS2LockCT;
extern func_rtdGammaGetFS2LockCT g_rtdGammaGetFS2LockCT;
